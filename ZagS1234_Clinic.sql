...
CREATE TABLE `Medicine` (
  ...
  `method_of_administration` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `Medicine` (`id`, `title`, `method_of_administration`, `description_of_the_action`, `side_effects`) VALUES
...
(5, 'витиминки', '1 раз', '1212', 'нету'),
(7, 'Витамин с', '1 раз', 'выва', 'нету');
...
INSERT INTO `Reception` (`id`, `date_and_place`, `inspection_place`, `symptoms`, `diagnosis`, `patient_instructions`, `patient_id`, `doctor_id`, `data`) VALUES
(1, '2023.11.20, Центральная городская поликлиника', 'Центральная городская поликлиника', 'слабость, рвота, тошнота', 'Отравление', 'принимать лекарства, пить много воды', 2, 1, '2023.11.20'),
(2, '2024.02.05, Центральная городская поликлиника', 'Центральная городская поликлиника', 'слабость, рвота, тошнота', 'Отравление', 'принимать лекарства, пить много воды', 4, 2, '2024.02.05'),
(3, '2023.02.15, Центральная поликлиника', ' Центральная поликлиника', '', 'Ветрянка', '', 3, 4, '2023.02.15'),
(4, '2023.02.15, Центральная поликлиника', ' Центральная поликлиника', '', 'Простуда', '', 4, 3, '2023.02.15');
